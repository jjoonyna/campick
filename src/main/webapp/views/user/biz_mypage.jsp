    ...
    <main id="main">
		...
		<div id="join_wrap">
			...
			<form>
				...
				<div id="join_menu">
					<input type="button" value="수정완료" class="button" id="user_change_ok" />
		...
		<div id="pw_change_display">
			...
			<form>
				<table id="join_t">
					...
					<tr>
						<th>새 비밀번호</th>
						<td><input type="password" name="new_user_pw" id="new_user_pw"
							class="pw" /></td>
					</tr>
					<tr>
						<th>새 비밀번호확인</th>
						<td><input type="password" name="new_user_pw2" id="new_user_pw2"
							class="pw" /></td>
					</tr>
